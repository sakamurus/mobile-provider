<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ShippingAddress.aspx.cs" Inherits="SemesterProject.ShippingAddress1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <center>
         <h2 style="font-weight:800; color:#001E45; margin-top:1.5%; font-size: 40px;">Shipping Address</h2>
     <hr />
       <fieldset>
       <div  id="divform2" runat="server">
           ...
           <table>
            ...
            <tr><td> 
               ...
               <asp:Label runat="server" AssociatedControlID="txtFullName" >Full Name</asp:Label></td>
               <td>
               ...
               <asp:RequiredFieldValidator runat="server" ControlToValidate="txtFullName"
                   CssClass="text-danger" ErrorMessage="The full name field is required." /></td></tr>
               </div>
           ...
           <tr><td><br /></td><td><br /></td></tr>
            ...
            <tr><td></td><td><p> <asp:Button ID="back" runat="server" Text="Back" CssClass="btn btn-default" PostBackUrl="~/CheckOut.aspx" />&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp<asp:Button ID="shippingAddress" runat="server" Text="Continue Checkout" CssClass="btn btn-default" PostBackUrl="~/Payment.aspx" /></p><br /><br /></td></tr>
          </div>
        </div>
