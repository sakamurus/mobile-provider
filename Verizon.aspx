<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Verizon.aspx.cs" Inherits="SemesterProject.Verizon"  MasterPageFile ="~/Site.Master" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2><%: Title %>.</h2>
    <h3 align="center"><font size="5" color="#0065b3">Verizon Top Ten Phones</font></h3>    
    <div class="container">
        <section>
        <div>
            <hgroup>
